...
in {
  networking = {
    ...
    hosts = {
      ...
      "${ip_v4_block}.113" = ["nixmini01.${domain}" "gk_mini01.${domain}" "lb01.${domain}"];
      "${ip_v4_block}.114" = ["nixmini02.${domain}" "gk_mini02.${domain}" "k8mgr01.${domain}"];
      "${ip_v4_block}.115" = ["nixmini03.${domain}" "gk_mini03.${domain}" "k8node01.${domain}"];
      "${ip_v4_block}.116" = ["nixmini04.${domain}" "gk_mini04.${domain}" "k8node02.${domain}"];
      "${ip_v4_block}.117" = ["nixmini05.${domain}" "gk_mini05.${domain}" "k8node03.${domain}"];
    };
    domain = "${domain}";
  };
}
